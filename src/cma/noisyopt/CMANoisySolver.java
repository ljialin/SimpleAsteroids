...
public class CMANoisySolver implements Solver {
    ...
    public CMANoisySolver(IObjectiveFunction fitFun, int nDim, int maxEvals) {
        this.fitFun = fitFun;
        this.nDim = nDim;
        ...
        cma.options.stopFitness = -2e6;       // optional setting
